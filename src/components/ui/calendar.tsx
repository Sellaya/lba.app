    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 sm:h-7 sm:w-7 bg-transparent p-0 opacity-50 hover:opacity-100 touch-manipulation active:scale-95"
        ),
        ...
        day: cn(
          ...
          "h-10 w-10 sm:h-9 sm:w-9 p-0 font-normal aria-selected:opacity-100 touch-manipulation active:scale-95"
        ),
